...
<body>
    <div class="wrapper">
        ...
        <section class="right">
            ...
            <p class="shirttext" id="js-shirt-text">vijays t-Shirt</p>
        </section>
        ...
        <section>
            ...
            <div class="options">
                ...
                <input id="shirtTextBox" maxlength="30" name="shirtText" onkeypress="printShirt()" onkeyup="printShirt()" type="text" value="Vijays Shirt">
